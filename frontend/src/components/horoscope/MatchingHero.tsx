...
export const MatchingHero = () => {
  ...
  const { bride, groom, total_points, max_points, compatibility_level, conclusion } = matchingData;

  // Render a minimal profile for a partner
  ...
  return (
    <GlassCard className="w-full p-8 md:p-12 relative overflow-hidden group">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-12 md:gap-8">
        ...
        {/* Center: The Massive Score Ring */}
        <div className="flex flex-col items-center justify-center flex-shrink-0 relative z-10">
          <p className="text-gold-primary tracking-[0.2em] text-xs uppercase mb-4 font-medium">Ashta Koota Score</p>
          
          <ScoreRing score={total_points} maxScore={max_points} size={220} strokeWidth={6} />
          
          <div className="mt-6 text-center max-w-[280px]">
            <h2 className="font-cinematic text-3xl font-bold text-white mb-2">{compatibility_level} Match</h2>
